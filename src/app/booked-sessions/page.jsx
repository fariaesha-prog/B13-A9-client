    ...
    <header className="bg-white border-b border-zinc-200 sticky top-0 z-40">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-14">
        ...
        <nav className="hidden md:flex items-center gap-1">
          {["Home", "Tutors", "Add Tutor", "My Tutors"].map(
            (item) => (
              <a
                key={item}
                href="#"
                className="px-3 py-1.5 text-sm text-zinc-500 hover:text-zinc-900 rounded-lg hover:bg-zinc-100 transition-colors"
              >
                {item}
              </a>
            )
          ...
          <a
            href="#"
            className="px-3 py-1.5 text-sm text-emerald-700 font-medium rounded-lg bg-emerald-50 border border-emerald-200"
          >
            My Sessions
          </a>
        </nav>
        ...
        <div className="flex items-center gap-3">
          {/* Toggle */}
          <div className="relative w-10 h-5 bg-emerald-500 rounded-full cursor-pointer">
